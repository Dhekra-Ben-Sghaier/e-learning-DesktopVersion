...
public class HomeController implements Initializable {
    ...
    private void Update_back_stage(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource(("/view/Update_back_stage.fxml")));
        Parent root = loader.load();
    ...
    private void Update_back_travail(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource(("/view/Update_back_travail.fxml")));
        Parent root = loader.load();
